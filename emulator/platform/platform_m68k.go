...
//                                          $0040_0000 - $00AF_FFFF - FREE SPACE (Future SDRAM Expanps2n Card?)
...
//                            $00BF_0000 - $00BF_FFFF - EXPANPS2N Chip Select
...
func (p *Platform) SetA2560U() {
        ...
        //p.PS2       = superio.New("ps2",         0x400)  // not implemented yet
...
func (p *Platform) SetFranken() {
        ...
        bus0.Attach(emu.M_USER, p.PS2,       emu.F_NONE, 0xAF_1000, 0xAF_13FF)
        ...
        bus1.Attach(emu.M_USER, p.PS2,       emu.F_NONE, 0xAF_1060, 0xAF_106f)
        ...
        bus1.Attach(emu.M_SV  , p.PS2,  emu.F_NONE, 0xAF_1000, 0xAF_13FF)
...
func (p *Platform) SetA2560K() {
        ...
        p.PS2        =  ps2.New("ps2",           0x10)
        p.GPU0       =  vicky3.New("gpu0",       0x20000)    // vram = 0x20_0000, text = 0x4000
        ...
        // m68k has RAM attached directly
        //bus0.Attach(emu.M_USER, ram0,         ram.F_MAIN, 0x00_0000, 0x3F_FFFF)
        //bus0.Attach(emu.M_SV,   p.GPU0,    vicky3.F_VRAM, 0x40_0000, 0x7F_FFFF)   

        bus0.Attach(emu.M_USER, p.GPU0,    vicky3.F_MAIN, 0xC4_0000, 0xC5_FFFF)
        bus0.Attach(emu.M_USER, p.GPU0,    vicky3.F_TEXT, 0xC6_0000, 0xC6_3FFF)
        bus0.Attach(emu.M_USER, p.GPU0,  vicky3.F_TEXT_C, 0xC6_8000, 0xC6_BFFF)
        bus0.Attach(emu.M_USER, p.GPU0,    vicky3.F_CRAM, 0xC6_C400, 0xC6_C4FF)

        bus0.Attach(emu.M_USER, p.GPU1,    vicky3.F_MAIN, 0xC8_0000, 0xC9_FFFF)
        bus0.Attach(emu.M_USER, p.GPU1,    vicky3.F_TEXT, 0xCA_0000, 0xCA_3FFF)
        bus0.Attach(emu.M_USER, p.GPU1,  vicky3.F_TEXT_C, 0xCA_8000, 0xCA_BFFF)
        bus0.Attach(emu.M_USER, p.GPU1,    vicky3.F_CRAM, 0xCA_C400, 0xCA_C4FF) 

        //bus0.Attach(emu.M_USER, ram0,        ram.F_MAIN, 0x00_0000, 0x3F_FFFF)
        //bus0.Attach(emu.M_SV,   p.GPU0,    vicky3.F_VRAM, 0x40_0000, 0x7F_FFFF)   

        bus0.Attach(emu.M_SV,   gabe0,    ram.F_MAIN, 0xC0_0000, 0xC1_FFFF)
        bus0.Attach(emu.M_SV,   p.PATA0,  emu.F_NONE, 0xC0_0400, 0xC0_040F)
        bus0.Attach(emu.M_SV,   p.PS2,    emu.F_NONE, 0xC0_2060, 0xC0_206F)
        bus0.Attach(emu.M_SV,   beat0,    ram.F_MAIN, 0xC2_0000, 0xC3_FFFF)

        bus0.Attach(emu.M_SV,   p.GPU0,    vicky3.F_MAIN, 0xC4_0000, 0xC5_FFFF)
        bus0.Attach(emu.M_SV,   p.GPU0,    vicky3.F_TEXT, 0xC6_0000, 0xC6_3FFF)
        bus0.Attach(emu.M_SV,   p.GPU0,  vicky3.F_TEXT_C, 0xC6_8000, 0xC6_BFFF)
        bus0.Attach(emu.M_SV,   p.GPU0,    vicky3.F_CRAM, 0xC6_C400, 0xC6_C4FF)
        ...
        bus0.Attach(emu.M_SV,   p.GPU1,    vicky3.F_CRAM, 0xCA_C400, 0xCA_C4FF) 
